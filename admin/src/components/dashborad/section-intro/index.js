    ...
    return (
        <SectionIntroBody className="d-flex justify-content-between">
            <div>
                ...
                <div>
                    <p>برای دیدن نظرات کاربران کلیک کنید.
                        نظرات کاربران در ابتدا در سایت نشان داده نمیشود. شما باید نظرات را در این قسمت تایید کنید
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <div>
                    <p>لیست تمامی کاربران در این قسمت است
                        شما میتوانید برای فعال و فیر فعال اکانت کاربران، یا سطح دسترسی آنان از این قسمت استقاده کنید
                    </p>
                </div>
            </div>
        </SectionIntroBody>
